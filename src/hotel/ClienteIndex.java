 ...
 * @author estebansg
 */
public class ClienteIndex extends javax.swing.JFrame {
    ...
    public ClienteIndex() {
        ...
        listaClientes = Hotel.listaClientes;
        initComponents();
    ...
    public ClienteIndex(ArrayList<Usuario> listaClientes){
        //Hotel.cargarListaClientes();
...
//    public ClienteIndex(boolean band) {
//        initComponents();
//        this.setLocationRelativeTo(null);
//        modelo = (DefaultTableModel) this.tableIndex.getModel();
//        Hotel.cargarListaClientes();
...
//    }
    ...
    private void initComponents() {
        ...
        btnRefrescar.setBounds(50, 30, 90, 30);
    ...
    private void btnMostrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMostrarActionPerformed
        ...
        new UsuarioForm(Integer.valueOf(tableIndex.getValueAt(tableIndex.getSelectedRow(),0).toString()),false).show();
        this.dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClienteIndex.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClienteIndex().setVisible(true);
            }
        });
    }
